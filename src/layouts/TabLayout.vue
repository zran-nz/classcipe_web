...
<!--      &lt;!&ndash; update-begin-author:taoyan date:20201221 for:此处删掉transition标签 不知道为什么加上后 页面路由切换的时候即1及菜单切到2及菜单的时候 两个菜单页面会同时出现300-500秒左右 &ndash;&gt;-->
...
<!--        <router-view v-if="reloadFlag"/>-->
<!--      </template>-->
<!--      &lt;!&ndash; update-end-author:taoyan date:20201221 for:此处删掉transition标签 不知道为什么加上后 页面路由切换的时候即1及菜单切到2及菜单的时候 两个菜单页面会同时出现300-500秒左右 &ndash;&gt;-->
<!--    </div>-->
<!--  </global-layout>-->
<!--</template>-->
...
<!--      changeTitle (title) {-->
<!--        const projectTitle = 'Classcipe Admin'-->
<!--        // 首页特殊处理-->
<!--        if (this.$route.path === indexKey) {-->
