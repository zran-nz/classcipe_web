...
<!--                </a-menu-item>-->
<!--              </template>-->
<!--              &lt;!&ndash;              <template v-if="$store.getters.roles.indexOf('expert') !== -1">&ndash;&gt;-->
<!--              &lt;!&ndash;                <a-menu-item @click="toggleType('topic', $t('teacher.my-content.topics-type'))">&ndash;&gt;-->
<!--              &lt;!&ndash;                  <span>{{ $t('teacher.my-content.topics-type') }}</span>&ndash;&gt;-->
...
<!--              </a-menu-item>-->
<!--              &lt;!&ndash;              <a-menu-item @click="toggleType('lesson', $t('teacher.my-content.lesson-type'))">-->
...
<!--                      &lt;!&ndash; Evaluation: 外置Start evaluation，Edit，折叠Delete, Duplicate&ndash;&gt;-->
...
<!--                        </div>-->
<!--                      </template>-->
<!--                      &lt;!&ndash; Task: 外置teacher-pace, student-pace, Edit, 折叠Delete, Duplicate, Previous session&ndash;&gt;-->
...
<!--                        </div>-->
<!--                      </template>-->
<!--                      &lt;!&ndash; Unit plan:外置Edit，折叠Delete, Duplicate&ndash;&gt;-->
...
<!--                              </a>-->
<!--                            </a-menu-item>-->
<!--                            &lt;!&ndash; Task里面有teacher-pace, student-pace, previous session &ndash;&gt;-->
<!--                            <template v-if="item.type === typeMap.task">-->
<!--                              <a-menu-item>-->
