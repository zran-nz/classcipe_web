...
<!--                                &lt;!&ndash;                            <div class="reset-edit-basic-info" >Edit Task Info</div>&ndash;&gt;-->
...
<!--                    </div>-->
<!--                  </div>-->
<!--                  &lt;!&ndash;quick-task recommend &ndash;&gt;-->
...
<!--              &lt;!&ndash;              <div class="template-show-filter">&ndash;&gt;-->
<!--              &lt;!&ndash;                <div class="icon" style="height:20px">&ndash;&gt;-->
<!--              &lt;!&ndash;                  <a-tooltip title="Expand filter" placement="right">&ndash;&gt;-->
<!--              &lt;!&ndash;                    <img&ndash;&gt;-->
<!--              &lt;!&ndash;                      v-if="!showTemplateFilter"&ndash;&gt;-->
<!--              &lt;!&ndash;                      src="~@/assets/icons/tag/add.png"&ndash;&gt;-->
<!--              &lt;!&ndash;                      @click="showTemplateFilter = !showTemplateFilter">&ndash;&gt;-->
<!--              &lt;!&ndash;                  </a-tooltip>&ndash;&gt;-->
<!--              &lt;!&ndash;                  <a-tooltip title="Collapse filter" placement="right">&ndash;&gt;-->
<!--              &lt;!&ndash;                    <img&ndash;&gt;-->
<!--              &lt;!&ndash;                      v-if="showTemplateFilter"&ndash;&gt;-->
<!--              &lt;!&ndash;                      src="~@/assets/icons/task/toggle.png"&ndash;&gt;-->
<!--              &lt;!&ndash;                      @click="showTemplateFilter = !showTemplateFilter">&ndash;&gt;-->
<!--              &lt;!&ndash;                  </a-tooltip>&ndash;&gt;-->
<!--              &lt;!&ndash;                </div>&ndash;&gt;-->
<!--              &lt;!&ndash;              </div>&ndash;&gt;-->
...
<!--                            <a-col :span='24'>-->
<!--                              &lt;!&ndash;                          <span class="sub-category">Knowledge focus </span>&ndash;&gt;-->
<!--                              <div-->
<!--                                class='sub-select'-->
...
<!--                          <div class='row-select row-select-assessments'>-->
<!--                            <a-col :span='24'>-->
<!--                              &lt;!&ndash;                          <span class="sub-category">Skill focus</span>&ndash;&gt;-->
<!--                              <div-->
<!--                                class='sub-select'-->
...
<!--                <div class='template-list' v-if='!templateLoading'>-->
<!--                  &lt;!&ndash;购物车效果截图 &ndash;&gt;-->
<!--                  &lt;!&ndash;                  <div class="slide-animate-cover" id="slide-animate-drawer" v-show="currentSlideCoverImgSrc">&ndash;&gt;-->
<!--                  &lt;!&ndash;                    <img&ndash;&gt;-->
<!--                  &lt;!&ndash;                      id="slide-animate-img-drawer"&ndash;&gt;-->
<!--                  &lt;!&ndash;                      :src="currentSlideCoverImgSrc"&ndash;&gt;-->
<!--                  &lt;!&ndash;                      class="slide-animate-item" />&ndash;&gt;-->
<!--                  &lt;!&ndash;                  </div>&ndash;&gt;-->
<!--                  <div-->
...
<!--                </div>-->
<!--              </div>-->
<!--              &lt;!&ndash;              <div class="template-action">&ndash;&gt;-->
<!--              &lt;!&ndash;                <div class="create-loading" v-if="creating">&ndash;&gt;-->
<!--              &lt;!&ndash;                  <a-spin />&ndash;&gt;-->
<!--              &lt;!&ndash;                </div>&ndash;&gt;-->
<!--              &lt;!&ndash;                <div style="position: absolute;left:20px"><a-radio :checked="onlyShowSelected" @click="onChangeShowSelected">Only selected template</a-radio></div>&ndash;&gt;-->
<!--              &lt;!&ndash;                <a-button&ndash;&gt;-->
<!--              &lt;!&ndash;                  v-if="!form.presentationId"&ndash;&gt;-->
<!--              &lt;!&ndash;                  @click="handleAddTemplate"&ndash;&gt;-->
<!--              &lt;!&ndash;                  :style="{'display': 'flex', 'align-items': 'center', 'justify-content': 'center', 'padding': '10px'}"&ndash;&gt;-->
<!--              &lt;!&ndash;                  shape="round"&ndash;&gt;-->
<!--              &lt;!&ndash;                  type="primary"&ndash;&gt;-->
<!--              &lt;!&ndash;                  :loading="creating">&ndash;&gt;-->
<!--              &lt;!&ndash;                  <img src="~@/assets/icons/task/path.png" class="btn-icon"/>&ndash;&gt;-->
<!--              &lt;!&ndash;                  <div class="btn-text">&ndash;&gt;-->
<!--              &lt;!&ndash;                    Create the task in Google Slides&ndash;&gt;-->
<!--              &lt;!&ndash;                  </div>&ndash;&gt;-->
<!--              &lt;!&ndash;                </a-button>&ndash;&gt;-->
<!--              &lt;!&ndash;                <a-button&ndash;&gt;-->
<!--              &lt;!&ndash;                  v-if="form.presentationId"&ndash;&gt;-->
<!--              &lt;!&ndash;                  @click="handleSelectedTemplate"&ndash;&gt;-->
<!--              &lt;!&ndash;                  :style="{'display': 'flex', 'align-items': 'center', 'justify-content': 'center', 'padding': '10px'}"&ndash;&gt;-->
<!--              &lt;!&ndash;                  shape="round"&ndash;&gt;-->
<!--              &lt;!&ndash;                  type="primary"&ndash;&gt;-->
<!--              &lt;!&ndash;                  :loading="creating">&ndash;&gt;-->
<!--              &lt;!&ndash;                  <img src="~@/assets/icons/task/path.png" class="btn-icon"/>&ndash;&gt;-->
<!--              &lt;!&ndash;                  <div class="btn-text">&ndash;&gt;-->
<!--              &lt;!&ndash;                    Save selected templates&ndash;&gt;-->
<!--              &lt;!&ndash;                  </div>&ndash;&gt;-->
<!--              &lt;!&ndash;                </a-button>&ndash;&gt;-->
<!--              &lt;!&ndash;              </div>&ndash;&gt;-->
<!--            </div>-->
...
<!--              />-->
<!--            </div>-->
<!--            &lt;!&ndash;            <div class="action-line">&ndash;&gt;-->
<!--            &lt;!&ndash;              &lt;!&ndash;              <a-button @click="handleCancelSelectedMyContent" class="button-item">Cancel</a-button>&ndash;&gt;&ndash;&gt;-->
<!--            &lt;!&ndash;              <a-button @click="handleConfirmSelectedMyContent" type="primary" shape="round" class="button-item" :loading="creating"> Save selected contents</a-button>&ndash;&gt;-->
<!--            &lt;!&ndash;            </div>&ndash;&gt;-->
<!--          </a-tab-pane>-->
<!--        </a-tabs>-->
<!--      </a-modal>-->
...
<!--            &lt;!&ndash;            <vue-record-audio mode="press" @result="handleAudioResult" />&ndash;&gt;-->
...
<!--        <div class='link-content-wrapper'>-->
<!--          &lt;!&ndash; 此处的questionIndex用于标识区分是哪个组件调用的，返回的事件数据中会带上，方便业务数据处理，可随意写，可忽略&ndash;&gt;-->
<!--          <new-browser-->
<!--            ref='newBrowser'-->
