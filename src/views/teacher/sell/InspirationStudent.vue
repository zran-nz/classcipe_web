<template>
  <div class="my-content">
    <div class="content-title">Inspiration for students</div>
    ...
    <course-list
      :loadData="loadData"
      :viewMode="viewMode"
      :optArray="['Check reviews', 'Edit', 'Preview']"
      ref="myCourseList"
    >
    </course-list>
  </div>
...
import { FindInspirationStudents } from '@/api/teacher'
  ...
  data() {
    return {
      ...
      loadData: (pageParams) => {
        ...
        return FindInspirationStudents(params)
      }
    }
  },
  created() {
