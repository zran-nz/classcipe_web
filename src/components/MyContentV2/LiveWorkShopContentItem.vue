<template>
  <div class='content-item' >
    <div class='cover' @click.prevent.stop="handleGoWork(content)">
      <div class='cover-block' :style="{'background-image': `url('${content.cover || (content.content && content.content.image) || '//dcdkqlzgpl5ba.cloudfront.net/1392467808404684802/file/202208140641519097-20220814143449.png'}')`}">
