  ...
  <div class="my-common-preview">
    ...
    <template v-else>
      ...
      <div class='extra-content-preview' v-if='[typeMap.task, typeMap["unit-plan"]].indexOf(type) !== -1'>
        ...
        <template v-if='type === typeMap["unit-plan"]'>
          <div class='unit-cover' :style="{'background-image': `url('${data.image || '//dcdkqlzgpl5ba.cloudfront.net/1392467808404684802/file/202208140641519097-20220814143449.png'}')`}">
          </div>
        </template>
  ...
  methods: {
    loadData () {
      ...
      if (this.type === this.typeMap['unit-plan']) {
        ...
        console.info('loadRecommendThumbnail')
