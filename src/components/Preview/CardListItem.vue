<template>
  <div class="cc-card">
    <div class="cover-img relative-position" :style="{backgroundImage: `url('${(content.image || '//dcdkqlzgpl5ba.cloudfront.net/1392467808404684802/file/202208140641519097-20220814143449.png')}')`, 'width' : width + 'rem'}">
