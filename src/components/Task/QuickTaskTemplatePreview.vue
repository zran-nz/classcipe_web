          ...
          <a-col class="left-preview" span="24" style="display:flex;flex-direction:row">
            ...
            <div class="carousel-page">
              <div class="img-list-wrapper">
                <div class="img-list">
                  <div class="img-item" :class="{'active-item': selectPageObjectIds.indexOf(item.id) !== -1 }" v-for="(item,index) in thumbnailList" :key="'index' + index" @click="handleAddAndGotoImgIndex(index)">
                    <img :src="item.contentUrl" />
                  </div>
                </div>
              </div>
