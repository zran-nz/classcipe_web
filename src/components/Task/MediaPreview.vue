<template>
  <div class="material-preview">
    ...
    <a-row class="top-header">
      ...
      <!--          <div class="icon" v-if="materialType === 'text'">-->
      <!--            <text-type-svg />-->
      <!--            <div class="icon-text">Text</div>-->
      <!--          </div>-->
      <!--          <div class="icon" v-if="materialType === 'image'">-->
      <!--            <image-type-svg />-->
      <!--            <div class="icon-text">Image</div>-->
      <!--          </div>-->
      <!--          <div class="icon" v-if="materialType === 'video'">-->
      <!--            <video-type-svg />-->
      <!--            <div class="icon-text">Video</div>-->
      <!--          </div>-->
      <!--          <div class="icon" v-if="materialType === 'audio'">-->
      <!--            <audio-type-svg />-->
      <!--            <div class="icon-text">Audio</div>-->
      <!--          </div>-->
      <!--          <div class="icon" v-if="materialType === 'iframe'">-->
      <!--            <youtube-type-svg />-->
      <!--            <div class="icon-text">Youtube</div>-->
      <!--          </div>-->
      <!--          <div class="icon" v-if="materialType === 'pdf'">-->
      <!--            <pdf-type-svg />-->
      <!--            <div class="icon-text">PDF</div>-->
      <!--          </div>-->
      <!--          <div class="icon" v-if="materialType === 'website'">-->
      <!--            <url-type-svg />-->
    ...
    <a-row class="preview-data-info" >
      <a-col class="slide-preview" span="24" >
        ...
        <a-col span="24">
          <div v-if="!mediaList.length" class="no-preview-img">
            <no-more-resources />
          </div>
        </a-col>
        <a-col span="24" style="display:flex;flex-direction:row">
          <div class="media-preview" >
            <a-carousel ref="carousel" arrows v-if="mediaList.length" :after-change="onChangePage" class="my-carousel">
              <div slot="prevArrow" class="custom-slick-arrow" style="left: -40px;zIndex: 9" >
                <a-icon type="left-circle"/>
              </div>
              <div slot="nextArrow" class="custom-slick-arrow" style="right: -30px;zIndex: 9" >
    ...
    <div class="page-info" v-if="mediaList && mediaList.length">
