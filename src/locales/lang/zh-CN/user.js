export default {
  ...
  'user.login.username.placeholder': '邮箱/ID',
  ...
  'user.login.login': '登录',
  'user.login.loginWithGoogle': '使用谷歌账户登录',
  'user.register.register': '注册',
  'user.register.name.placeholder': '请输入你的用户名',
  'user.register.name.required': '请输入你的用户名!',
  'user.register.email.placeholder': 'Kate.edu@gmail.com',
  'user.register.password.placeholder': '请至少输入 6 个字符',
